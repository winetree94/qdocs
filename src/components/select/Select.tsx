...
export const Value: React.ForwardRefExoticComponent<Select.SelectValueProps & React.RefAttributes<HTMLDivElement>> =
  React.forwardRef(({ children, className, ...props }, forwardedRef) => {
    return (
...
export const Icon: React.ForwardRefExoticComponent<Select.SelectIconProps & React.RefAttributes<HTMLDivElement>> =
  React.forwardRef(({ children, className, ...props }, forwardedRef) => {
    return (
...
export const Portal: React.FC<Select.SelectPortalProps> = ({ children, ...props }) => {
  return <Select.Portal {...props}>{children}</Select.Portal>;
};

export const Content: React.ForwardRefExoticComponent<Select.SelectContentProps & React.RefAttributes<HTMLDivElement>> =
  React.forwardRef(({ children, className, ...props }, forwardedRef) => {
    return (
...
export const Group: React.ForwardRefExoticComponent<Select.SelectGroupProps & React.RefAttributes<HTMLDivElement>> =
...
export const Label: React.ForwardRefExoticComponent<Select.SelectLabelProps & React.RefAttributes<HTMLDivElement>> =
  React.forwardRef(({ children, className, ...props }, forwardedRef) => {
    return (
...
export const Item: React.ForwardRefExoticComponent<Select.SelectItemProps & React.RefAttributes<HTMLDivElement>> =
  React.forwardRef(({ children, className, ...props }, forwardedRef) => {
    return (
