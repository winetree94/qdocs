...
> = React.forwardRef(({ children, className, ...props }, forwardedRef) => {
  return (
    <Select.Value
      {...props}
      ref={forwardedRef}
      className={clsx(className, styles.SelectValue)}>
      {children}
    </Select.Value>
  );
});
...
> = React.forwardRef(({ children, className, ...props }, forwardedRef) => {
  return (
    <Select.Icon
      {...props}
      ref={forwardedRef}
      className={clsx(className, styles.SelectIcon)}>
      {children}
    </Select.Icon>
  );
});
...
> = React.forwardRef(({ children, className, ...props }, forwardedRef) => {
  return (
    <Select.Content
      {...props}
      ref={forwardedRef}
      className={clsx(className, styles.SelectContent)}>
      {children}
    </Select.Content>
  );
});
...
> = React.forwardRef(({ children, className, ...props }, forwardedRef) => {
  return (
    <Select.ScrollUpButton
      {...props}
      ref={forwardedRef}
      className={clsx(className, styles.SelectScrollButton)}>
      {children}
    </Select.ScrollUpButton>
  );
});
...
> = React.forwardRef(({ children, className, ...props }, forwardedRef) => {
  return (
    <Select.Viewport
      {...props}
      ref={forwardedRef}
      className={clsx(className, styles.SelectViewport)}>
      {children}
    </Select.Viewport>
  );
});
...
> = React.forwardRef(({ children, className, ...props }, forwardedRef) => {
  return (
    <Select.Label
      {...props}
      ref={forwardedRef}
      className={clsx(className, styles.SelectLabel)}>
      {children}
    </Select.Label>
  );
});
...
> = React.forwardRef(({ children, className, ...props }, forwardedRef) => {
  return (
    <Select.Separator
      {...props}
      ref={forwardedRef}
      className={clsx(className, styles.SelectSeparator)}>
      {children}
    </Select.Separator>
  );
});
