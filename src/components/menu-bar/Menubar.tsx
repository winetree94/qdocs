...
export const Root = React.forwardRef<HTMLDivElement, Menubar.MenubarProps>(({ children, className, ...props }, ref) => {
  return (
...
export const Trigger = React.forwardRef<HTMLButtonElement, QueueButtonProps & Menubar.MenubarTriggerProps>(
...
export const Content = React.forwardRef<HTMLDivElement, Menubar.MenubarContentProps>(
...
export const CheckboxItem = React.forwardRef<HTMLDivElement, Menubar.MenubarCheckboxItemProps>(
  ({ children, className, ...props }, ref) => {
    return (
...
export const ItemIndicator = React.forwardRef<HTMLSpanElement, Menubar.MenubarItemIndicatorProps>(
  ({ children, className, ...props }, ref) => {
    return (
...
export const RadioGroup = React.forwardRef<HTMLDivElement, Menubar.MenubarRadioGroupProps>(
  ({ children, className, ...props }, ref) => {
    return (
...
export const RadioItem = React.forwardRef<HTMLDivElement, Menubar.MenubarRadioItemProps>(
  ({ children, className, ...props }, ref) => {
    return (
...
export const SubTrigger = React.forwardRef<HTMLDivElement, Menubar.MenubarSubTriggerProps>(
  ({ children, className, ...props }, ref) => {
    return (
...
export const SubContent = React.forwardRef<HTMLDivElement, Menubar.MenubarSubContentProps>(
  ({ children, className, ...props }, ref) => {
    return (
...
export const Separator = React.forwardRef<HTMLDivElement, Menubar.MenubarSeparatorProps>(
  ({ children, className, ...props }, ref) => {
    return (
